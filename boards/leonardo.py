...
class LeonardoBoard:
    def __init__(self):
        ...
        self.board_name = "Arduino Leonardo"
    ...
    def is_leonardo(self, p):
        try:
            ...
            if "2341" in hwid:
                if "32u4" in hwid or "leonardo" in desc:
                    return True
    ...
    def get_leonardo_devices(self):
        return [d for d in self.scan() if d["type"] == "ARDUINO_LEONARDO"]
    ...
    def detect(self):
        ...
        return {
            ...
            "leonardo_devices": self.get_leonardo_devices(),
